      ...
      <div className="max-w-2xl px-4 mx-auto sm:px-6 md:max-w-7xl lg:px-8">
        <div className="relative my-16 flex  h-full min-h-[400px] w-full items-center justify-center rounded-2xl bg-gradient-to-br from-black/50 to-black/20 sm:my-16">
          <div className="w-full">
            <img src={heroimg} alt="" title="" className="w-[1280px] rounded-2xl object-cover" />
          </div>
          <div className="absolute p-5 space-y-1 left-1 rounded-3xl sm:left-8 sm:space-y-3 sm:text-left">
            ...
            <Button text="Visit Our Shop" className="text-white bg-black hover:bg-white hover:text-black" to="/shop" />
          </div>
        </div>
      </div>
    </div>
