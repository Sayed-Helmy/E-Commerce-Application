...
const ProductForm = () => {
  ...
  return (
    <div className="container mx-auto max-w-7xl py-5 px-2 sm:my-7">
      <h3 className="mb-7 text-3xl font-bold">Create Product</h3>
      <form
        onSubmit={submitHandler}
        className="grid grid-cols-1  gap-6 rounded-2xl border-2 py-10 px-3 sm:px-10 md:grid-cols-2 md:space-x-16"
      >
        {/* left side */}
          ...
          <div className="flex items-center justify-start space-x-2 sm:space-x-4">
            ...
            <div>
              <input
                ...
                name="onSale"
                id="prod-onSale"
                className=" text-black ring-2 ring-black/50"
              />
            </div>
          </div>
          {/* OnSalePrice */}
        ...
        <div className="col-span-2 mt-4">
          <button
            type="submit"
            className="float-right w-32 cursor-pointer rounded-md border border-transparent bg-black px-4 py-2 text-center text-sm font-medium text-white shadow-sm hover:bg-black/80 focus:outline-none focus:ring-2 focus:ring-black/50 focus:ring-offset-2 disabled:bg-gray-400"
          >
            Submit
          </button>
        </div>
