    ...
    <>
      {orders?.length > 0 ? (
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 md:max-w-7xl lg:px-8 ">
                ...
                <div className="flex w-full flex-col space-y-6 rounded bg-gray-50  px-4 py-6 md:p-6 xl:p-8   ">
                  ...
                  <div className="flex w-full flex-col items-center justify-center space-y-4 border-b border-gray-200 pb-4">
                    <div className="flex w-full  justify-between">
                      ...
                      <p className="text-base leading-4 text-gray-600">${orders[0].priceSubtotal}</p>
                    </div>
                    <div className="flex w-full items-center justify-between">
                      <p className="text-base leading-4 text-gray-800">Discount</p>
                      <p className="text-base leading-4 text-gray-600">
                        -${orders[0].amountDiscount} ({(orders[0].totalPrice / orders[0].priceSubtotal) * 100}
                        %)
                      </p>
                    </div>
                    <div className="flex w-full items-center justify-between">
                  ...
                  <div className="flex w-full items-center justify-between">
                    ...
                    <p className="text-base font-semibold leading-4 text-gray-600">${orders[0].totalPrice}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mt-8 flex w-full flex-col space-y-4 rounded bg-gray-50 px-4 py-6 md:justify-start">
            <div className="flex">
              <h3 className="mr-6 text-xl font-semibold leading-5 text-gray-800">Order status:</h3>
              <p className="rounded-lg bg-green-300 px-3">{orders[0].status}</p>
            </div>
            <div className="flex">
              <h3 className="mr-6 text-xl font-semibold leading-5 text-gray-800">Delivery on:</h3>
              <p className=""> 12/12/2022</p>
            </div>
          </div>
        </div>
      ) : (
