          ...
          <section aria-labelledby="products-heading" className="pt-6 pb-24">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <div className="hidden lg:block">
                {categories &&
                  filters.map((section) => (
                    <Disclosure defaultOpen={section.opened} as="div" key={section.id} className="border-b border-gray-200 py-6">
                      {({ open }) => (
                        <>
                ...
                <form>
                  ...
                  <PriceFilter min={0} max={1000} onChange={({ min, max }) => console.log(`min = ${min}, max = ${max}`)} />
                  <button type="submit" Value="" className="mx-auto mt-16 block rounded-md bg-black px-4 text-white">
                    Filter
                  </button>
                </form>
              </div>
