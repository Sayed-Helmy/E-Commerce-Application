      ...
      >
        ...
        <div className="flex items-center space-x-2 sm:space-x-4">
          ...
          <input
            ...
            id="cat-Image"
            name="image"
            className="w-60  rounded-md border border-gray-300 bg-white  text-sm font-medium  text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-1 focus:ring-black/50 focus:ring-offset-1"
          />
        </div>
